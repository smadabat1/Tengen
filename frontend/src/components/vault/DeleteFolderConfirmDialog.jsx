...
export function DeleteFolderConfirmDialog({ open, onOpenChange, folder, onConfirm, isPending }) {
  return (
            ...
            <Dialog.Content asChild>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
                  <strong className="text-foreground font-medium">"{folder?.name || 'Untitled'}"</strong> will be permanently
                  deleted. All notes inside it will remain, but will be uncategorized.
                </p>
